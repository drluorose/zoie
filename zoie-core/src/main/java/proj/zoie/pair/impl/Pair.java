...
public class Pair<R extends IndexReader, D> implements Zoie<R, D> {
    ...
    private class MyPairAdmin implements PairAdminMBean {
        ...
        public Date getLastDiskIndexModifiedTime() {
            ...
            if (Pair.this._zoieTwo != null) {
                d2 = Pair.this._zoieTwo.getAdminMBean()
        ...
        public void setMaxBatchSize(int maxBatchSize) {
            ...
            if (Pair.this._zoieOne != null) {
                Pair.this._zoieOne.getAdminMBean().setMaxBatchSize(
                        maxBatchSize);
            }
            if (Pair.this._zoieTwo != null) {
                Pair.this._zoieTwo.getAdminMBean().setMaxBatchSize(
                        maxBatchSize);
            }
        }
        ...
        public void setMergeFactor(int mergeFactor) {
            if (Pair.this._zoieOne != null) {
                Pair.this._zoieOne.getAdminMBean()
                        .setMergeFactor(mergeFactor);
            }
            if (Pair.this._zoieTwo != null) {
                Pair.this._zoieTwo.getAdminMBean()
                        .setMergeFactor(mergeFactor);
            }
        }
        ...
        public String getDiskIndexerStatus() {
            if (Pair.this._zoieTwo != null) {
                return Pair.this._zoieTwo.getAdminMBean()
        ...
        public void setMaxMergeDocs(int maxMergeDocs) {
            if (Pair.this._zoieTwo != null) {
                Pair.this._zoieTwo.getAdminMBean().setMaxMergeDocs(
                        maxMergeDocs);
            }
            if (Pair.this._zoieOne != null) {
                Pair.this._zoieOne.getAdminMBean().setMaxMergeDocs(
                        maxMergeDocs);
            }
        }
        ...
        public void setNumLargeSegments(int numLargeSegments) {
            if (Pair.this._zoieTwo != null) {
                Pair.this._zoieTwo.getAdminMBean().setNumLargeSegments(
                        numLargeSegments);
            }
            if (Pair.this._zoieOne != null) {
                Pair.this._zoieOne.getAdminMBean().setNumLargeSegments(
                        numLargeSegments);
            }
        }
        ...
        public void setMaxSmallSegments(int maxSmallSegments) {
            if (Pair.this._zoieTwo != null) {
                Pair.this._zoieTwo.getAdminMBean().setMaxSmallSegments(
                        maxSmallSegments);
            }
            if (Pair.this._zoieOne != null) {
                Pair.this._zoieOne.getAdminMBean().setMaxSmallSegments(
                        maxSmallSegments);
            }
        }
        ...
        public long getDiskIndexSizeBytes() {
            long size = 0;
            if (Pair.this._zoieTwo != null) {
                size = Pair.this._zoieTwo.getAdminMBean()
        ...
        public int getDiskIndexSegmentCount() throws IOException {
            int count = 0;
            if (Pair.this._zoieTwo != null) {
                count = Pair.this._zoieTwo.getAdminMBean()
