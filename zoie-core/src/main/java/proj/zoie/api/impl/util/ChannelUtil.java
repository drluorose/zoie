...
public class ChannelUtil {
     ...
     * @throws IOException
     */
    private static int writeByteBuffer(WritableByteChannel channel, ByteBuffer buf, int bytesToWrite)
            throws IOException {
    ...
    public static boolean fillBuffer(ReadableByteChannel channel, ByteBuffer buf, boolean clear)
            throws IOException {
        if (clear) {
            buf.clear();
        }
